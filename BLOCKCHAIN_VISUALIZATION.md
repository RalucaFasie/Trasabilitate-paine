...
✅ Display blocks with hash and previousHash  
✅ Two implementation options (client-side & CI)  
✅ Example HTML/JS with Romanian/English comments  
...
├── app-static.js          # Option 2: Load from JSON
├── README.md              # Public folder documentation
└── data/                  # Generated by CI (gitignored)
    └── blocks.json        # Precomputed blockchain data

scripts/
└── generate-blocks.js     # CI script to generate blockchain data
...
- ✅ Works immediately without CI
- ✅ Demonstrates real-time hashing
- ✅ Easy to modify data
...
- ✅ Faster page load (no computation)
...
1. **Genesis Block** (🌱) - Initial blockchain block
2. **Ferma** (🌾) - Farm with crop information
3. **Moară** (⚙️) - Mill processing data
4. **Senzori IoT** (📡) - IoT sensor readings
5. **Brutărie** (🍞) - Bakery production details
6. **Magazin** (🛒) - Store/retail information
